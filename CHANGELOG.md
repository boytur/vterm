...
- Add a search box to the Local Branches dropdown to filter branches as you type; Enter checks out the first match, Esc closes, and "No branches found" shows when the filter matches nothing. The search box now has a magnifier icon to its left.
